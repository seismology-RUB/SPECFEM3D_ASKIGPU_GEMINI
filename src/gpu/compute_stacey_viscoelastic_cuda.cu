...
void FC_FUNC_(compute_stacey_viscoelastic_cuda,
              COMPUTE_STACEY_VISCOELASTIC_CUDA)(long* Mesh_pointer,
                                                ...
                                                int* COUPLE_WITH_INJECTION_TECHNIQUE_f,
                                                int* INJECTION_TECHNIQUE_TYPE_f) {

  TRACE("compute_stacey_viscoelastic_cuda");

  Mesh* mp = (Mesh*)(*Mesh_pointer); //get mesh pointer out of fortran integer container
  int FORWARD_OR_ADJOINT = *FORWARD_OR_ADJOINT_f;
  int COUPLE_WITH_INJECTION_TECHNIQUE = *COUPLE_WITH_INJECTION_TECHNIQUE_f;
  int INJECTION_TECHNIQUE_TYPE = *INJECTION_TECHNIQUE_TYPE_f;
