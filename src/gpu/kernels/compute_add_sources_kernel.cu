...
//        if (i == 2 && j == 1 && k == 4) {
//           int idx;
//           idx = INDEX5(NSOURCES,NDIM,NGLLX,NGLLX,isource,2,i,j,k);
//           printf("myrank,ispec,i,j,k,sourcearrays,stf,accel: %d %d %d %d %d %e %e %e\n",myrank,ispec,i,j,k,sourcearrays[idx],stf,accel[iglob*3+2]);
//        }
      }
    }
  }
