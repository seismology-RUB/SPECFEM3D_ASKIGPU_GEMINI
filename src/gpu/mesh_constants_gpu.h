...
//
//  WF: texture disabled since deprecated in CUDA 12
//  
#ifdef USE_CUDA
...
// textures (disabled because deprectated in CUDA 12)
#ifdef USE_CUDA
...
typedef struct mesh_ {
  ...
  // ------------------------------------------------------------------ //
  // Coupling with injection (GEMINI)
  // ------------------------------------------------------------------ //

  //in fortran these are single precision real arrays.
  realw *veltrac1;
  realw *veltrac2;
  // these are general doubles
  realw alip;
  realw blip;
  ...
  int ASKI_np_local;
  int ASKI_ntl;
  int ASKI_store_veloc;
  int* d_ASKI_indx_local;
  realw* d_ASKI_efactors_re;
  realw* d_ASKI_efactors_im;
  realw* d_ASKI_stf_re;
  realw* d_ASKI_stf_im;
  realw* d_ASKI_local_disp;
  realw* d_ASKI_local_strain;
  realw* d_ASKI_local_spectra_re;
  realw* d_ASKI_local_spectra_im;
  realw* d_ASKI_taper_values;
  int* d_ASKI_ntaper_start;
