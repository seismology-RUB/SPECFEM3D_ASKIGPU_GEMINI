...
specfem3D_OBJECTS = \
	...
	$O/multiple_sequential_sources.spec.o \
	$(EMPTY_MACRO)
...
specfem3D_SHARED_OBJECTS = \
	...
	$O/cartesian_box_spherical_chunk_mappings.shared.o \
	$(EMPTY_MACRO)
...
specfem3D_MODULES = \
	...
	$(FC_MODDIR)/specfem_par_aski.$(FC_MODEXT) \
...
${E}/xspecfem3D: $(specfem3D_OBJECTS) $(specfem3D_SHARED_OBJECTS) $(specfem3D_GEMINI_OBJECTS)
	@echo ""
	@echo $(INFO_GPU_SPECFEM)
	@echo $(specfem3D_GEMINI_OBJECTS)
	@echo ""
	${FCLINK} -o ${E}/xspecfem3D $(specfem3D_OBJECTS) $(specfem3D_SHARED_OBJECTS) $(specfem3D_GEMINI_OBJECTS)\
	                             $(specfem3D_MESH_OBJECTS) $(MPILIBS) $(GPU_LINK) $(VTKLIBS) $(SPECFEM_LINK_FLAGS) \
	                             $(HDFLIB)
	@echo ""
...
${E}/xspecfem3D: $(specfem3D_OBJECTS) $(specfem3D_SHARED_OBJECTS) $(specfem3D_GEMINI_OBJECTS)
	...
	@echo ""
	${FCLINK} -o ${E}/xspecfem3D $(specfem3D_OBJECTS) $(specfem3D_SHARED_OBJECTS) $(specfem3D_GEMINI_OBJECTS) \
	    $(specfem3D_MESH_OBJECTS) $(MPILIBS) $(VTKLIBS) $(SPECFEM_LINK_FLAGS) $(HDFLIB)
...
## gemini coupling and ASKI
$O/compute_stacey_viscoelastic.spec.o: $O/errorMessage.gem.o $O/anyRankRealArray.gem.o $O/hdfWrapper.gemmpi.o
$O/couple_with_injection.spec.o: $O/errorMessage.gem.o $O/hdfWrapper.gemmpi.o
$O/iterate_time.spec.o: $O/errorMessage.gem.o $O/hdfWrapper.gemmpi.o
$O/finalize_simulation.spec.o: $O/travelTimes.gem.o
$O/specfem3D_for_ASKI.spec.o: $O/errorMessage.gem.o $O/hdfWrapper.gemmpi.o $O/axesRotation.gem.o $O/travelTimes.gem.o
...
## modules
$O/%.spec_module.o: $S/%.f90 $O/shared_par.shared_module.o $O/travelTimes.gem.o
