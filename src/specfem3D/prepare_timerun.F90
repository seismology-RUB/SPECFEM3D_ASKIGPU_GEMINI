...
!=====================================================================
  ...
  ! prepare extensions by ASKI (added by WF)
  call prepare_timerun_ASKI()

  ! prepares GPU arrays
  if (GPU_MODE) call prepare_GPU()

  ! prepares ASI extensions for GPU
  if (GPU_MODE) call prepare_ASKI_GPU()
...
!
  ...
  if (ELASTIC_SIMULATION) then
    ...
    ! not needed anymore, do not deallocate here but rather in finalize_simulation (WF)
    ! it is alloated and set to zero in read_mesh_database
    ! deallocate(rmass)
...
!
  ...
  end subroutine zero_lddrk_arrays
!
!-------------------------------------------------------------------------------------------------
!
...
!----------------------------------------------------------------
!
  subroutine allocate_moment_tensor_derivatives()
  ...
  end subroutine allocate_moment_tensor_derivatives
!
!-------------------------------------------------------------------------------------------------
!
