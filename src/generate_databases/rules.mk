...
generate_databases_GEMINI_OBJECTS = \
...
XGENERATE_DATABASES_OBJECTS = \
	...
	$(COND_MPI_OBJECTS) $(generate_databases_GEMINI_OBJECTS)
...
$E/xgenerate_databases: $(XGENERATE_DATABASES_OBJECTS)
	...
	@echo ""
	${FCLINK} -o ${E}/xgenerate_databases $(XGENERATE_DATABASES_OBJECTS) $(MPILIBS) $(HDFLIB)
	@echo ""
...
# Version file
$O/generate_databases.gen.o: ${SETUP}/version.fh $O/hdfWrapper.gemmpi.o
...
# Gemini
$O/model_1d_prem.gen.o: $O/axesRotation.gem.o
