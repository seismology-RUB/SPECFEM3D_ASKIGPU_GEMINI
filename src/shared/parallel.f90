...
!
!-------------------------------------------------------------------------------------------------
!  ADDED FOR USE WITH ASKI (WF: 11.12.2020)  
!
...
!
  ...
  subroutine recv_sp(recvbuf, recvcount, dest, recvtag)
  ...
  end subroutine recv_sp
!
!-------------------------------------------------------------------------------------------------
!

  subroutine sendv_sp(sendbuf, sendcount, dest, sendtag)
