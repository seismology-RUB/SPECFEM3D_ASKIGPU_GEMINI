...
FLAGS_CHECK = -cpp -std=f2003 -fimplicit-none -frange-check -fmax-errors=10 -pedantic -pedantic-errors -Waliasing -Wampersand -Wcharacter-truncation -Wline-truncation -Wsurprising -Wno-tabs -Wunderflow -ffpe-trap=invalid,zero,overflow -Wunused -Werror -O3 -finline-functions
...
CUDA_FLAGS = 
CUDA_INC =  -I${SETUP}
#CUDA_LINK =  -L/usr/local/cuda-12/lib64 -lcudart -lstdc++
CUDA_LINK =  -L/opt/nvidia/hpc_sdk/Linux_x86_64/23.11/cuda/lib64 -lcudart -lstdc++
CUDA_DEBUG = --cudart=shared

NVCC = /opt/nvidia/hpc_sdk/Linux_x86_64/23.11/cuda/bin/nvcc
...
##GENCODE_HIP = $(GENCODE_50)         # --with-hip=cuda7 ..
...
#HDF_INCLUDES = /rscratch/minos01/wolle/for-gfortran-$(fcversion)/hdf5-1.10.5/hdf5/include
#HDFLIB = -L/rscratch/minos01/wolle/for-gfortran-$(fcversion)/hdf5-1.10.5/hdf5/lib -lhdf5_fortran -lhdf5
HDF_INCLUDES = /usr/lib/x86_64-linux-gnu/hdf5/openmpi/include
